...
Different versions of this tool are provided as snowman_editor.jar files. Also, the source code an more information about this tool can be found in its repository:

https://github.com/GerardMT/Snowman-Editor