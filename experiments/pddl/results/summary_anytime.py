...
for f in next(os.walk(path + '/results/'))[1]:
	...
	# Get optimal
	lines = open(instance_path + '/out').readlines()
	results[f] = {'optimal': lines[-2] == 'search exit code: 0\n'}
...
csv.write('instance,cost,time,optimal,preprocessing_time\n')
