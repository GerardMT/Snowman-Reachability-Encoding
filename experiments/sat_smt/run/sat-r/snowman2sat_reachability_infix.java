/**
 * @class snowman2sat_reachability_infix
 * @author Miquel Bofill
 * @version 1.0
 * @date 2021-04-23
 * @brief Translation of "A good snowman is hard to build" instance to SAT formula, with reachability (without move actions); using infix notation with &, |, !, ->, <-> operators in order to feed the formula to a tseitin converter (Limboole)
...
public class snowman2sat_reachability_infix {
